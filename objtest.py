...
index_urls = []
#index_urls.append('http://www.gonu.com/index.aspx?path=whockey')
#index_urls.append('http://hurstathletics.com/index.aspx?path=whockey')
index_urls.append('http://msumavericks.com/index.aspx?path=whockey')
